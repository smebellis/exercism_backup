...
def is_criticality_balanced(temperature, neutrons_emitted) -> None:
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if output < (.90 * threshold):
        return "LOW"
    
    threshold_range = threshold * .10
    lower_bound = threshold - threshold_range
    upper_bound = threshold + threshold_range
