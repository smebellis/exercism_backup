...
def get_leftover_of_bills(amount, denomination):
    ...
    value_of_bills = get_value_of_bills(denomination, bills)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    adjusted_rate = (exchange_rate * spread_rate) + exchange_rate
    
    money = exchange_money(budget, adjusted_rate)
    amt = get_leftover_of_bills(money, denomination)
    
    
    return int(money - amt)
